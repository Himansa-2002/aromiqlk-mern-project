        ...
        <div className="max-w-6xl mx-auto px-8 grid md:grid-cols-2 gap-14">
          ...
          <div>
            ...
            <div className="flex gap-3.5 flex-wrap mb-3">
              ...
              <a
                href={`https://wa.me/94788778808?text=${encodeURIComponent(`Hello Aromiq, I am interested in ${product.name} (${getSelectedSize().label}). Can I get more details?`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto px-8 py-4 flex items-center justify-center gap-3 text-xs uppercase tracking-widest bg-[#25D366] text-white hover:brightness-110 transition rounded"
              >
                  ...
                  <div className="flex items-center gap-2 h-full py-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <button
                        ...
                        className={`text-2xl transition-colors hover:scale-110 ${star <= rating ? "text-gold-bright drop-shadow-[0_0_8px_rgba(201,169,97,0.8)]" : "text-line"}`}
