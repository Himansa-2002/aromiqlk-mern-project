...
async function seed() {
  ...
  await Collection.insertMany([
    ...
    { name: 'Arabic Perfume Oils', slug: 'arabic-perfume-oils', featured: true },
    { name: 'Luxury Gift Sets', slug: 'luxury-gift-sets', featured: true },
    { name: 'Decants (5ml & 10ml)', slug: 'decants', featured: true },
  ]);
